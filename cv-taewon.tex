...
\leftheader{%
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:twsong@sch.ac.kr}{\texttt{twsong@sch.ac.kr}}}\hfill
  % \makefield{\faTwitter}{\href{https://twitter.com/overleaf_example}{\texttt{@overleaf\_example}}}
  \makefield{\faLinkedin}
  {\href{https://www.linkedin.com/in/taewon-song-1b2b26139/}{\texttt{Taewon Song}}}\hfill
  %% Next line
  \makefield{\faGlobe}{\url{https://sites.google.com/view/ainolab/}}
